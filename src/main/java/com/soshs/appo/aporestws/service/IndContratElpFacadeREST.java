...
import com.soshs.appo.aporestws.entities.IndContratElp;
import com.soshs.appo.aporestws.entities.IndContratElpPK;
...
public class IndContratElpFacadeREST extends AbstractFacade<IndContratElp> {
    ...
    private IndContratElpPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.soshs.appo.aporestws.entities.IndContratElpPK key = new com.soshs.appo.aporestws.entities.IndContratElpPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.soshs.appo.aporestws.entities.IndContratElpPK key = getPrimaryKey(id);
