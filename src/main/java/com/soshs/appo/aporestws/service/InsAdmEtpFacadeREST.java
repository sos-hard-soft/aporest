...
import com.soshs.appo.aporestws.entities.InsAdmEtp;
import com.soshs.appo.aporestws.entities.InsAdmEtpPK;
...
public class InsAdmEtpFacadeREST extends AbstractFacade<InsAdmEtp> {
    ...
    private InsAdmEtpPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.soshs.appo.aporestws.entities.InsAdmEtpPK key = new com.soshs.appo.aporestws.entities.InsAdmEtpPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.soshs.appo.aporestws.entities.InsAdmEtpPK key = getPrimaryKey(id);
