...
import com.soshs.appo.aporestws.entities.ResultatElp;
import com.soshs.appo.aporestws.entities.ResultatElpPK;
...
public class ResultatElpFacadeREST extends AbstractFacade<ResultatElp> {
    ...
    private ResultatElpPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.soshs.appo.aporestws.entities.ResultatElpPK key = new com.soshs.appo.aporestws.entities.ResultatElpPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.soshs.appo.aporestws.entities.ResultatElpPK key = getPrimaryKey(id);
