...
import com.soshs.appo.aporestws.entities.InsPedagogiAnu;
import com.soshs.appo.aporestws.entities.InsPedagogiAnuPK;
...
public class InsPedagogiAnuFacadeREST extends AbstractFacade<InsPedagogiAnu> {
    ...
    private InsPedagogiAnuPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.soshs.appo.aporestws.entities.InsPedagogiAnuPK key = new com.soshs.appo.aporestws.entities.InsPedagogiAnuPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.soshs.appo.aporestws.entities.InsPedagogiAnuPK key = getPrimaryKey(id);
