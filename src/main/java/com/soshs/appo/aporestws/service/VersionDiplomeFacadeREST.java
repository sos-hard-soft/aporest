...
import com.soshs.appo.aporestws.entities.VersionDiplome;
import com.soshs.appo.aporestws.entities.VersionDiplomePK;
...
public class VersionDiplomeFacadeREST extends AbstractFacade<VersionDiplome> {
    ...
    private VersionDiplomePK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.soshs.appo.aporestws.entities.VersionDiplomePK key = new com.soshs.appo.aporestws.entities.VersionDiplomePK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.soshs.appo.aporestws.entities.VersionDiplomePK key = getPrimaryKey(id);
