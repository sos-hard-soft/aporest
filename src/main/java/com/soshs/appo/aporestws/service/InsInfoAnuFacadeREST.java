...
import com.soshs.appo.aporestws.entities.InsInfoAnu;
import com.soshs.appo.aporestws.entities.InsInfoAnuPK;
...
public class InsInfoAnuFacadeREST extends AbstractFacade<InsInfoAnu> {
    ...
    private InsInfoAnuPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.soshs.appo.aporestws.entities.InsInfoAnuPK key = new com.soshs.appo.aporestws.entities.InsInfoAnuPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.soshs.appo.aporestws.entities.InsInfoAnuPK key = getPrimaryKey(id);
