...
import com.soshs.appo.aporestws.entities.IndBac;
import com.soshs.appo.aporestws.entities.IndBacPK;
...
public class IndBacFacadeREST extends AbstractFacade<IndBac> {
    ...
    private IndBacPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.soshs.appo.aporestws.entities.IndBacPK key = new com.soshs.appo.aporestws.entities.IndBacPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.soshs.appo.aporestws.entities.IndBacPK key = getPrimaryKey(id);
