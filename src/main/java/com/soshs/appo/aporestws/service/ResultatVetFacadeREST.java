...
import com.soshs.appo.aporestws.entities.ResultatVet;
import com.soshs.appo.aporestws.entities.ResultatVetPK;
...
public class ResultatVetFacadeREST extends AbstractFacade<ResultatVet> {
    ...
    private ResultatVetPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.soshs.appo.aporestws.entities.ResultatVetPK key = new com.soshs.appo.aporestws.entities.ResultatVetPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.soshs.appo.aporestws.entities.ResultatVetPK key = getPrimaryKey(id);
